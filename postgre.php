...
$host = "YOUR_PG_HOST";       // Render PostgreSQL host
$port = "5432";               // PostgreSQL port
$dbname = "bookmysaloon";     // Database name
$user = "bookmysaloon_user";  // DB username
$password = "YOUR_PG_PASSWORD"; // DB password
...
$query = "INSERT INTO bookings (name, email, phone, services, date, time, payment_screenshot) 
          VALUES ($1, $2, $3, $4, $5, $6, $7)";
$result = pg_query_params($conn, $query, [$name, $email, $phone, $services, $date, $time, $screenshot]);
